...
function ProfileCard() {
  return (
    ...
    >
      {/* Orbital symbol particles */}
      <div style={{ position: 'absolute', inset: '-60px', pointerEvents: 'none', zIndex: 5 }}>
        {SYMBOLS.map((s, i) => (
          <motion.span
            key={i}
            ...
            style={{
              ...
              fontWeight: 700,
              opacity: 0.7,
              textShadow: `0 0 10px ${s.color}, 0 0 20px ${s.color}60`,
              whiteSpace: 'nowrap',
              userSelect: 'none',
            }}
          >
      ...
      >
        ...
        <div style={{
          height: 1,
          background: 'linear-gradient(90deg, transparent, rgba(0,255,255,0.7), rgba(150,0,255,0.4), transparent)',
        }} />
        ...
        {/* Frosted glass info panel — overlaid on the bottom */}
        <div style={{
          position: 'absolute',
          bottom: 0,
          left: 0,
    ...
    >
      <div className="container mx-auto px-8 flex items-center justify-between gap-8">
        ...
        >
          ...
          <motion.h2
            variants={itemVariants}
            className="font-poppins font-semibold text-2xl text-white mb-6"
          ...
          <motion.p
            variants={itemVariants}
            className="font-poppins text-gray-300 text-base leading-relaxed mb-10 max-w-md"
          >
      ...
      <motion.div
        ...
        className="absolute bottom-8 right-8 flex items-center gap-2 text-gray-500 text-xs font-poppins tracking-widest"
      >
